class left {
    constructor(f1 = 12, f2 = 24, f3 = 48, f4 = 84, f5 = 132, f6 = "on") {
        this.a = f1;
        this.b = f2;
        this.c = f3;
        this.d = f4;
    ...
    dataStore4 = {
        ...
        1: "ACÉROLA (cerise des Antilles)",
        2: "Acerola – West Indian Cherry",
        3: "Pomme",
        4: "Apple",
        5: "Apricots",
        6: "Avocado",
        ...
        51: "Peaches",
        52: "Pear",
        53: "Persimmon – Japanese",
        54: "Pitaya (Dragonfruit)",
        55: "Pineapple",
        56: "Pitanga",
        57: "Plantain",
        58: "Plums",
    ...
    dance() {
        return console.log(this.dataStore1)
    }

    walk() {
        return console.log(this.dataStore2)
    }

    talk() {
        return console.log(this.dataStore3)
    }
